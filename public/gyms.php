    ...
    <div class="container-fluid py-3">
      <div class="row">
        <div class="col-8">
          ...
          <a class="btn btn-primary">Explore Passes</a>
        </div>
      </div>
    </div>
  </div>
...
<main class="container-md p-4" id="main">
  <section class="pt-4">
    <div class="row">
      <div class="col-xl-3">
        <h2 class="text-dark text-xl-end s-heading">Featured Gym</h2>
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <img src="<?= h($feature->avatar_url); ?>" class="img-fluid img-thumbnail avatar m-3" alt="<?= h($session->name); ?> profile photo." height="200" width="200">
