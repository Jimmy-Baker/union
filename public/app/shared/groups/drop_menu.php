...
<div class="col-auto d-none d-sm-block">
  ...
  <ul class="dropdown-menu dropdown-menu-dark bg-primary dropdown-menu-end text-end" aria-labelledby="groupMenuLink">
    ...
    <li><a class="dropdown-item<?= active_class('view') ?>" href="<?= url_for('app/shared/groups/view.php?id=' . $group->id); ?>">View Group</a></li>
    <li><a class="dropdown-item<?= active_class('edit') ?>" href="<?= url_for('app/shared/groups/edit.php?id=' . $group->id); ?>">Edit Group</a></li>
    <li><a class="dropdown-item<?= active_class('delete') ?>" href="<?= url_for('app/shared/groups/delete.php?id=' . $group->id); ?>">Delete Group</a></li>
    <?php } ?>
  </ul>
</div>