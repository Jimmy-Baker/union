...
<main class="container-md p-4" id="main">
  <form action="<?= url_for('/app/shared/locations/delete.php?id=' . u($id)); ?>" method="post">
    ...
    <div class="row justify-content-evenly">
      <div class="col-sm-4 col-md-3 mb-3 d-grid">
        <a class="btn shadow btn-outline-primary" href="<?= url_for('app/shared/locations/view.php?id=' . u($location->id)); ?>">Cancel Deletion</a>
      </div>
      <div class="col-sm-4 col-md-3 mb-3 d-grid">
