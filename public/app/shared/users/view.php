    ...
    <div class="row justify-content-between">
      ...
      <div class="col-auto d-none d-sm-block">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenuLink">
          <li><a class="dropdown-item text-end" href="<?= url_for('app/shared/users/edit.php?id='. h(u($user->id))); ?>">Edit User</a></li>
          <li><a class="dropdown-item text-end" href="<?= url_for('app/shared/users/delete.php?id='. h(u($user->id))); ?>">Delete User</a></li>
        </ul>
      </div>
    </div>
  </div>
