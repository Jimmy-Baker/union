...
<div class="col-auto d-none d-sm-block">
  ...
  <ul class="dropdown-menu dropdown-menu-dark bg-primary dropdown-menu-end text-end" aria-labelledby="userMenuLink">
    ...
    <li><a class="dropdown-item<?= active_class('view') ?>" href="<?= url_for('app/shared/users/view.php?id=' . $user->id); ?>">View User</a></li>
    <li><a class="dropdown-item<?= active_class('edit') ?>" href="<?= url_for('app/shared/users/edit.php?id=' . $user->id); ?>">Edit User</a></li>
    <li><a class="dropdown-item<?= active_class('delete') ?>" href="<?= url_for('app/shared/users/delete.php?id=' . $user->id); ?>">Delete User</a></li>
    <?php } ?>
  </ul>
</div>