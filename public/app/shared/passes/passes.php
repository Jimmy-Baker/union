    ...
    <div class="row justify-content-between">
      <nav aria-label="breadcrumb" class="col-auto">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active text-primary" aria-current="page">Passes</a></li>
        </ol>
      </nav>
      <?php 
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <tr class="align-middle text-nowrap">
                  <td><?= h($active->id) ?></td>
                  <td><a href="<?= url_for('/app/shared/users/view.php?id=' . u($active->user_id)); ?>"><?= h($active->user_id) ?></a></td>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="pass actions">
                      <a class="btn btn-primary" href="<?= url_for('/app/shared/passes/view.php?id=' . u($active->id)); ?>">View</a>
                      <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"><span class="visually-hidden">Toggle Dropdown</span></button>
                      <ul class="dropdown-menu dropdown-menu-dark bg-primary dropdown-menu-end text-end">
                        <li><a class="dropdown-item" href="<?= url_for('/app/shared/passes/edit.php?id=' . u($active->id)); ?>">Edit</a></li>
                        <li><a class="dropdown-item" href="<?= url_for('/app/shared/passes/delete.php?id=' . u($active->id)); ?>">Delete</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <tr class="align-middle text-nowrap">
                  <td><?= h($expired->id) ?></td>
                  <td><a href="<?= url_for('/app/shared/users/view.php?id=' . u($expired->user_id)); ?>"><?= h($expired->user_id) ?></a></td>
                  ...
                  <td>
                    <div class="btn-group" role="group" aria-label="pass actions">
                      <a class="btn btn-primary" href="<?= url_for('/app/shared/passes/view.php?id=' . u($expired->id)); ?>">View</a>
                      <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false"><span class="visually-hidden">Toggle Dropdown</span></button>
                      <ul class="dropdown-menu dropdown-menu-dark bg-primary dropdown-menu-end text-end">
                        <li><a class="dropdown-item" href="<?= url_for('/app/shared/passes/edit.php?id=' . u($expired->id)); ?>">Edit</a></li>
                        <li><a class="dropdown-item" href="<?= url_for('/app/shared/passes/delete.php?id=' . u($expired->id)); ?>">Delete</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
