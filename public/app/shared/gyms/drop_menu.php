...
<div class="col-auto d-none d-sm-block">
  ...
  <ul class="dropdown-menu dropdown-menu-dark bg-primary dropdown-menu-end text-end" aria-labelledby="gymMenuLink">
    ...
    <li><a class="dropdown-item<?= active_class('view') ?>" href="<?= url_for('app/shared/gyms/view.php?id=' . $gym->id); ?>">View Gym</a></li>
    <li><a class="dropdown-item<?= active_class('edit') ?>" href="<?= url_for('app/shared/gyms/edit.php?id=' . $gym->id); ?>">Edit Gym</a></li>
    <li><a class="dropdown-item<?= active_class('delete') ?>" href="<?= url_for('app/shared/gyms/delete.php?id=' . $gym->id); ?>">Delete Gym</a></li>
    <?php } ?>
  </ul>
</div>