  ...
  <section class="row mx-0 mb-4 gy-3">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-8">
          <div class="card-body">
            ...
            <p class="card-text"><small class="text-muted">Logged in as Gym<?= access(["GM", "GS"], [" Manager", " Staff"]) ?></small></p>
          </div>
        </div>
      </div>
    </div>
    <!-- <div class="col card shadow me-2 ms-md-3 px-0">
      ...
      <div class="card-body row row-cols-1 g-2">
        <a class="col btn btn-primary disabled">My Passes</a>
        <a class="col btn btn-primary" href="<?= url_for('app/shared/users/view.php?id=' . $session->user_id); ?>">My Profile</a>
        <a class="col btn btn-primary disabled">Button</a>
      </div>
    </div>
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body text-end pt-0">
                  <a href="#" class="btn btn-primary disabled">Manage Groups</a>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body text-end pt-0">
                  <a href="#" class="btn btn-primary disabled">Manage Gyms</a>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body text-end pt-0">
                  <a href="#" class="btn btn-primary disabled">Manage Locations</a>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body text-end pt-0">
                  <a href="#" class="btn btn-primary disabled">Manage Events</a>
                </div>
              </div>
            </div>
            <div class="col">
