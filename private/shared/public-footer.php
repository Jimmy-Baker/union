<footer class="mt-5 p-5 bg-primary text-light">
  ...
  <div class="row gy-4 pt-4">
    ...
    <div class="col-6 col-sm-4">
      <h3>Accounts</h3>
      <ul class="nav flex-column">
        <li class="nav-item"><a href="<?= url_for("/app/login.php") ?>" class="nav-link link-light">Log In</a></li>
        <li class="nav-item"><a href="<?= url_for("/app/signup.php") ?>" class="nav-link link-light">Sign Up</a></li>
